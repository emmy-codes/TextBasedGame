...
<div class="torches">
  ...
  <div class="outerbox">
    ...
    <ul class="controlstext">
      ...
      <li><span class="orange">Get</span> - Pick up an item.</li>
    ...
    <div class="centreboxes">
      <div class="topbox">
        <p class="textp">Welcome to The Secret Realm: Journey into Kaos. You, the hero, will embark on an epic journey and uncover lost secrets and amazing artifacts. 
            Can you master the arts to tackle the challenges ahead? Your journey awaits.
        </p>
        <a href="mainForest.html" class="button">Enter the Realm</a>
      </div>
      <div class="bottombox">
      </div>
    </div>
